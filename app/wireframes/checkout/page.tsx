      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
             <label className="flex items-start gap-3 p-3 border border-gray-300 rounded-lg cursor-pointer bg-white">
                <input type="radio" name="address" className="mt-0.5" defaultChecked />
                <span className="text-sm bg-gray-100 text-gray-700 px-2 py-1 rounded inline-block">
